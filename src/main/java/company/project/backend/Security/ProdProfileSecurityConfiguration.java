...
public class ProdProfileSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    public void configure(AuthenticationManagerBuilder auth) throws Exception {
        ...
        auth.inMemoryAuthentication()
                .withUser("dobbed").password("inquisitor").roles("USER").and()
                .withUser("ollie").password("serve").roles("USER", "ADMIN");
    }
